import { Attribute, Property, FHTMLTextAreaElement } from "./element";
...
export declare const TextArea: Class;
export declare function createTextArea(option?: Option): TextArea;
