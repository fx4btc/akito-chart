...
Decimal.config({ toExpPos: 0 })</pre>
    ...
    <p>
      To extent this precision, assign a string or Decimal value with about 15 digits more than the
      maximum precision required. The default value enables a working precision of about
      <code>100</code> digits.
    </p>
    <p>
